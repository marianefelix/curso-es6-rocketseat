...
var TodoList = /*#__PURE__*/function (_Lista) {
  ...
  return TodoList;
}(Lista); //classe com metodo estatico
...
console.log(nome);
console.log(resto); //exemplo com array
...
console.log(a);
console.log(b);
console.log(c); //exemplo com parametros de funcao
...
console.log(arr3); //alterando valores de objetos 
